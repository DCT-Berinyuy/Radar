...
class AppColors {
  ...
  static const Color surfaceLowest =
      Color(0xFF0E0E0E); // surface-container-lowest
  ...
  static const Color surfaceHighest =
      Color(0xFF353534); // surface-container-highest
  ...
  static const Color primaryContainer =
      Color(0xFF00FF41); // primary-container (Cyber Green)
  static const Color cyberGreen =
      Color(0xFF00FF41); // alias — use for active signals
  ...
  static const Color waveformGrid =
      Color(0x1A4B8EFF); // secondaryContainer @ 10%
}
...
class AppTextStyles {
  ...
  // ── Inter — structural UI ─────────────────────────────────────────────────
  static TextStyle h1({Color color = AppColors.onSurface}) => GoogleFonts.inter(
        fontSize: 32,
  ...
  static TextStyle h2({Color color = AppColors.onSurface}) => GoogleFonts.inter(
        fontSize: 24,
...
class AppStroke {
  ...
  static const double waveformLine =
      1.5; // waveform stroke (thin-line icon spec)
}
    ...
    return base.copyWith(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          foregroundColor: AppColors.onSurface,
          side: const BorderSide(
              color: AppColors.outline, width: AppStroke.hairline),
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(AppRadius.base)),
          padding: const EdgeInsets.symmetric(
              horizontal: AppSpacing.md, vertical: AppSpacing.sm + 2),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle:
            WidgetStateProperty.resolveWith((states) => AppTextStyles.monoLabel(
                  color: states.contains(WidgetState.selected)
                      ? AppColors.cyberGreen
                      : AppColors.onSurfaceVariant,
                )),
